...
public class FilialBankServiceSessionTest extends TestCase {
	...
	public long testlogin() throws AxisFault {
	...
	public Antragssteller testGetAntragsteller(long sessionID) throws AxisFault {
		...
		if (result != null && result.length > 0) {
			...
			return antragsteller[0];
		}
		return null;
	}

	public void testUpdateAntragssteller(long sessionID, Antragssteller antragssteller) throws AxisFault {
		ServiceClient sender = getServiceClient(0);
	...
	public void testGetTilgungsPlan(long sessionID) throws AxisFault {
		ServiceClient sender = getServiceClient(0);
	...
	public void testInsertAntragsteller(long sessionID, Antragssteller antragssteller) throws AxisFault {
		ServiceClient sender = getServiceClient(0);
	...
	public void testlogoff(long sessionID) throws AxisFault {
		ServiceClient sender = getServiceClient(0);
	...
	@Test
	public void testALL() throws AxisFault {
		long sessionID = testlogin();
		Antragssteller as = testGetAntragsteller(sessionID);
		testGetTilgungsPlan(sessionID);
		testInsertAntragsteller(sessionID, as);
		testUpdateAntragssteller(sessionID, as);
		testlogoff(sessionID);
	}
}
